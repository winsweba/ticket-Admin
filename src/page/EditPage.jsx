import { Box, Button, Flex, FormLabel, Input, Select, Text } from '@chakra-ui/react';
...
const EditPage = ({TicketData}) => {
    ...
    const [ticketFormData, setTicketFormData] = useState({
      ...
      const getDataTicket = TicketData.filter( tb => tb.autoID === autoID).map((tb, index) => {
    ...
    <Box p={5} shadow='md' borderWidth='1px'mb={10}>
           <Text p={2} fontSize='md' as='b'>Name: {tb.ticketFormData.firstName}</Text>
           <Text p={2} fontSize='md' as='b'>{tb.ticketFormData.lastName}</Text>
           <Text p={2} fontSize='md' as='b'>Phone No.:{tb.ticketFormData.phoneNumber}</Text>
           <Text p={2} fontSize='md' as='b'>From {tb.ticketFormData.departure}</Text>
           <Text p={2} fontSize='md' as='b'>To {tb.ticketFormData.destination}</Text>
           <Text p={2} fontSize='md' as='b'>Leaving Time: {tb.ticketFormData.timing}</Text>
           <Text p={2} fontSize='md' as='b'>Date: {tb.ticketFormData.date}</Text>
           <Text p={2} fontSize='md' as='b'>Ticket ID: {tb.autoID}</Text>
...
<FormLabel  htmlFor="phoneNumber">
          ...
          <FormLabel  htmlFor="ticketAmount">
            ...
            <Flex>
              ...
              <Button onClick={navigateBack} colorScheme='red' variant='outline'>
                Cancel
                </Button>
              </Box>
            </Flex>
  ...
  return (
    ...
    <Box p={5} shadow='md' borderWidth='1px'mb={5}>
           <Text fontSize='xl' as='b'>Edit Ticket</Text>
